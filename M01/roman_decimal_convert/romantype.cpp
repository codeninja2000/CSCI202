...
RomanType::RomanType(std::string romanNumeral)
    : m_roman{romanNumeral}, m_decimal{0}, m_conversionError{false}
{
...
void RomanType::resetConversionError()
{
  m_conversionError = false;
}

bool RomanType::conversionError() const
{
